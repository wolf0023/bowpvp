...
execute if score $countdown timer matches 100.. run function bowpvp:prepare/prepare_game
execute if score $countdown timer matches 100.. run scoreboard players set @a[scores={ingame=1}] ingame 2
execute if score $countdown timer matches 100.. run scoreboard players set $gm timer 0